    ...
    <div className="px-8 w-full h-full flex lg:flex-row flex-col justify-between items-start mt-20 gap-10 ">
       <div className="w-full lg:w-[756px] flex flex-col items-start gap-16">
          { close && (
            ...
            <p className="w-full h-full flex items-center justify-start text-[#007B65] text-xs sm:text-base">¡su vuelo ha sido reservado con éxito! Su número de confirmación es #381029404387</p>
          ...
          <div className=" w-full flex flex-col items-start justify-start gap-2">
            ...
            <p className="text-[#7C8DB0] text-sm sm:text-base font-medium">Gracias por reservar su viaje con TripUMG. A continuación encontrará un resumen de su viaje al aeropuerto de Narita en Tokio, Japón. Hemos enviado una copia de su confirmación de reserva a su dirección de correo electrónico. También puedes volver a encontrar esta página en <span className="text-[#605DEC]"> Mis viajes.</span></p>
          </div>
          <div className="w-full flex flex-col items-start justify-start gap-4">
            ...
            <p className="text-[#7C8DB0] text-sm sm:text-base font-normal">Asiento 9F (clase turista, ventanilla), 1 maleta facturada</p>
             </div>
             <div className="w-full flex flex-col items-start gap-2 mt-8">
             <p className="text-[#7C8DB0] text-base sm:text-lg font-semibold">Llega el 21 de marzo de 2023</p>
             <div
              className="w-full cursor-pointer border-[1px] border-[#E9E8FC] hover:bg-[#F6F6FE] transition-all duration-300 focus:bg-[#F6F6FE]"
            >
              <FlightCard
            ...
            <p className="text-[#7C8DB0] text-sm sm:text-base font-normal">Asiento 4F (ejecutivo, ventanilla), 1 maleta facturada</p>
             </div>
          </div>
          ...
          <div className="w-full h-full sm:w-[400px] flex flex-col items-start gap-3 ">
             ...
             <div className="flex items-center justify-between w-full text-[#6E7491] text-sm sm:text-base gap-3" >
                <p>Tasas de equipaje</p>
                <p>$0</p>
             </div>
             <div className="flex items-center justify-between w-full text-[#6E7491] text-sm sm:text-base gap-3" >
                <p>Mejora de asiento (ejecutivo))</p>
                <p>$199</p>
             </div>
             <div className="flex items-center justify-between w-full text-[#6E7491] text-sm sm:text-base gap-3" >
                <p>Subtotal</p>
          ...
          <h1 className="text-[#6E7491] text-xl sm:text-2xl font-bold">Comparta su itinerario de viaje</h1>
          <p className="text-[#7C8DB0] text-base sm:text-lg font-normal">Puede enviar su itinerario por correo electrónico a cualquier persona introduciendo aquí su dirección de correo electrónico.</p>
          <form className="w-full h-full flex flex-col items-start justify-start gap-5 mt-5">
              ...
              <button className="bg-[#605DEC] text-[#FAFAFA] text-base px-2 py-3 rounded hover:bg-white border-[1px] border-[#605DEC] hover:text-[#605DEC] transition-all duration-200">Enviar itinerario por e-mail</button>
              </div>
          </div>
          <div className="w-full h-full flex flex-col items-start justify-start gap-4">
